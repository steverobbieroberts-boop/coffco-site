const NAV_ITEMS = [
  ...
  { label: 'Operational Concept', href: 'opscon.html', num: '1a' },
  { label: 'Operating Environment', href: 'operating-environment.html', num: '1b' },
  { label: 'Assumptions & Deps', href: 'assumptions.html', num: '1c' },
  { label: 'Requirements (SRS)', href: 'srs.html', num: '2' },
  { label: 'Architecture', href: 'architecture.html', num: '3' },
  { label: 'State Machine', href: 'state-machine.html', num: '3a' },
  { label: 'System Design', href: 'design.html', num: '4' },
  { label: 'Analysis & FMECA', href: 'analysis.html', num: '5' },
  { label: 'Market Trade Study', href: 'trade-study.html', num: '5a' },
  { label: 'Implementation', href: 'implementation.html', num: '6' },
  { label: 'BIV Schedule', href: 'schedule.html', num: '6a' },
  { label: 'Investor Deck', href: 'investor.html', num: '6b' },
  { label: 'HMI Prototype', href: 'hmi.html', num: '6c' },
  { label: 'Cloud Ops Dashboard', href: 'cloudops-wrapper.html', num: '6d' },
